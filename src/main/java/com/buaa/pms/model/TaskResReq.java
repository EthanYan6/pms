...
public class TaskResReq {
    ...
    public String getResAbilityType() {
        return resAbilityType;
    }

    public void setResAbilityType(String resAbilityType) {
        this.resAbilityType = resAbilityType;
    }
}
